...
WebUI.setText(findTestObject('Object Repository/Page_Fado - Mua Hng Quc T Cao Cp T M, Nht, c, Anh/input_mz-header-vsearch__keyword-input'), 
    'PRX 40 Quartz Black Dial Men\'s Watch T137.410.11.051.00')

WebUI.click(findTestObject('Object Repository/Page_Fado - Mua Hng Quc T Cao Cp T M, Nht, c, Anh/span_submit-btn-bg'))

WebUI.click(findTestObject('Object Repository/Page_Mua PRX 40 Quartz Black Dial Mens Watc_5fdbd1/div_Classic F91W Series Quartz Watch  Water_340624'))
